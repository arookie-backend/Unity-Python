...
while camera_video.isOpened():
    ...
    if (time2 - time1) > 0:
        ...
        time1 = time2
        cv2.putText(frame, 'FPS: {0:.2f}'.format(frames_per_second), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
